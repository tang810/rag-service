...
def run_pdf_chunks_embeddiing_extract(
    ...
    pdf_output = run_pdf_workflow(input_record, write_pdf_db=write_pdf_db)
    ...
    if should_extract:
        ...
        extract_output = asyncio.run(run_offline_extract_for_doc(doc_id=doc_id, filename=input_record.filename))
    else:
